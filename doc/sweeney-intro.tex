...
%\label{intro}
%
%SPARQL Protocol and RDF Query Language (SPARQL) is the language used to communicate with a triplestore in order to query the data or to modify it. Using this language, queries can be made to 
